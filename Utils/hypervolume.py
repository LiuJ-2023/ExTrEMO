# Implementation of hypervolume indicator taken from DEAP package
# Github link: https://github.com/DEAP/deap/blob/bfd3af80d7594e9548c9e2b8f21381293dd13354/deap/tools/_hypervolume/pyhv.py
...
if __name__ == "__main__":
    ...
    import numpy as np
    pointset = np.random.rand(1000, 3)
    # print(pointset)
    ref = np.array([1.1, 1.1, 1.1])
    print('hypervolume = ', hv(pointset, ref))